...
namespace CoreSploit.Enumeration
{
    public class GPO
    {
        ...
        //This function will require some modifications in order to make it work properly with System.DirectoryServices.Protocol
        /**
        /// <summary>
        ...
        public static bool GetRemoteAccessPolicies(string Domain, string DomainController, string SearchScope, string SearchBase)
        {
            ...
            {
                //Might just have to make this into a ldapconnection and have it support credentials
