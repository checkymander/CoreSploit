...
namespace CoreSploit.Enumeration
{
    public class Network
    {
        ...
        public static CoreSploitResultList<PortScanResult> PortScan(string ComputerName, int Port, bool Ping = true,
            int Timeout = 250)
        {
        ...
        /// <returns>List of PortScanResults</returns>
        public static CoreSploitResultList<PortScanResult> PortScan(IList<string> ComputerNames, int Port,
        ...
        /// <param name="Threads">Number of threads with which to portscan simultaneously</param>
        /// <returns>List of PortScanResults</returns>
        public static CoreSploitResultList<PortScanResult> PortScan(string ComputerName, IList<int> Ports,
            bool Ping = true, int Timeout = 250, int Threads = 100)
        {
        ...
        /// <returns></returns>
        public static CoreSploitResultList<PingResult> Ping(string ComputerName, int Timeout = 250)
        {
...
#warning Causes a core dump on Linux
        ...
        /// </summary>
        public sealed class PingResult : CoreSploitResult
        {
        ...
        /// </summary>
        public sealed class PortScanResult : CoreSploitResult
        {
            public string ComputerName { get; } = "";
        ...
        private class Utilities
        {
            private static IList<string> ConvertCidrToIPs(string CidrComputerName)
            {
                ...
                {
                    IPAddresses.Add(String.Format("{0}.{1}.{2}.{3}", i >> 24, (i >> 16) & 0xff, (i >> 8) & 0xff,
                        i & 0xff));
                }
